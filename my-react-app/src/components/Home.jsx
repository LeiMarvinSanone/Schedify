...
const Home = () => {
  ...
  const handlePrevDay = () => {
    const currentIndex = days.findIndex(d => d.short === selectedDay);
    const prevIndex = currentIndex === 0 ? days.length - 1 : currentIndex - 1;
    const prevDay = days[prevIndex].short;
    setSelectedDay(prevDay);
    const schedulesForDay = getSchedulesForDay(prevDay);
    setDaySchedules(schedulesForDay);
  };
  ...
  const handleNextDay = () => {
    ...
    const nextDay = days[nextIndex].short;
    setSelectedDay(nextDay);
    const schedulesForDay = getSchedulesForDay(nextDay);
    setDaySchedules(schedulesForDay);
  };
        ...
        <div className="day-view-modal">
          <div className="day-view-header">
            ...
            <div className="day-navigation">
              <button className="nav-btn prev-btn" onClick={handlePrevDay} title="Previous day">
              ...
              <button className="nav-btn next-btn" onClick={handleNextDay} title="Next day">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
